...
public class User {
	...
	public Set<NewsCompany> getNewsCompanySet() {
		return newsCompanySet;
	}

	public void setNewsCompanySet(Set<NewsCompany> newsCompanySet) {
		this.newsCompanySet = newsCompanySet;
	}
